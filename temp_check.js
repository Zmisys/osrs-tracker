...
// Browser API stubs for syntax checking
var document = { getElementById: ()=>({value:'',textContent:'',innerHTML:'',style:{},classList:{add:()=>{},remove:()=>{},toggle:()=>{},contains:()=>false},querySelectorAll:()=>[],querySelector:()=>({}),addEventListener:()=>{},closest:()=>null,click:()=>{}}), querySelector:()=>({}), querySelectorAll:()=>[], addEventListener:()=>{}, documentElement:{classList:{add:()=>{},remove:()=>{}}} };
var window = { matchMedia: ()=>({matches:false, addEventListener:()=>{}}), location:{hash:'',href:''}, open:()=>{} };
var localStorage = { getItem:()=>null, setItem:()=>{} };
var setTimeout = ()=>{};
var fetch = async()=>({text:async()=>'',json:async()=>({}),ok:true,headers:{get:()=>''}});
var console = { log:()=>{}, warn:()=>{}, error:()=>{} };
var alert = ()=>{};
var confirm = ()=>true;
var encodeURIComponent = (s)=>s;
var decodeURIComponent = (s)=>s;
var atob = (s)=>s;
var btoa = (s)=>s;
var AbortController = function(){this.signal={};this.abort=()=>{}};
